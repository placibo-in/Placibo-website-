    ...
    <>
      ...
      <CourseLayout title={course.name}>
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8 md:p-12 rounded-lg shadow-xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Build with Python and Django?</h2>
          <p className="text-blue-200 mb-6 max-w-xl mx-auto">Join our next batch to master one of the most powerful backend frameworks.</p>
