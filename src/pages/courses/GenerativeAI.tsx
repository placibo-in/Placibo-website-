    ...
    <>
      ...
      <CourseLayout title={course.name}>
        ...
        <div className="mt-16 text-center bg-gray-100 p-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">Ready to Build the Future with AI?</h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">Join our next batch and get hands-on experience with the most exciting technology today.</p>
          <Button onClick={onOpen} size="lg" className="bg-blue-600 hover:bg-blue-700">
