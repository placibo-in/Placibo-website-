          ...
          {slides.map((slide) => (
            <CarouselItem key={slide.id}>
              <div className="relative w-full h-[75vh] md:h-[90vh] max-h-[700px] text-white">
                ...
                <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-end items-center text-center pb-16 md:pb-24">
                  {(slide.enroll_button_visible || slide.syllabus_button_visible) && (
